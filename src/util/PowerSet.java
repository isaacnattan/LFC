...
/**
 * Calcula o conjunto dos subconjuntos de um dado conjunto.
 * @author http://stackoverflow.com/questions/15483036/java-generating-power-set-with-subset-length-between-3-and-a-max
 * @param <E> 
 */
public class PowerSet<E> implements Iterator<Set<E>>, Iterable<Set<E>> {
    ...
    public static void main(String[] args) {
        ...
        PowerSet<Character> pset = new PowerSet<>(set, 0, 10);
        int count = 1;
